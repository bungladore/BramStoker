	...
	public class LoaderItem extends LoaderCore {
		...
		override public function auditSize():void {
			if (_auditStream == null) {
				...
				_auditStream.addEventListener(IOErrorEvent.IO_ERROR, _auditStreamHandler, false, 0, true);
		...
		protected function _closeStream():void {
			if (_auditStream != null) {
				...
				_auditStream.removeEventListener(IOErrorEvent.IO_ERROR, _auditStreamHandler);
